...
defineEmits(["decrementar-cantidad", "incrementar-cantidad", "agregar-carrito", "eliminar-producto", "limpiar-carrito"])
          ...
          <div class="carrito">
            ...
            <div id="carrito" class="bg-white p-3">
              ...
              <div v-else>
                ...
                <button class="btn btn-dark w-100 mt-3 p-2" @click="$emit('limpiar-carrito')">Vaciar Carrito</button>
              </div>
            </div>
          </div>
        </nav>
